...
class Eval():
    def __init__(self, class_num):
        ...
        self.color_palette = [0, 0, 0, 255, 255, 255, 70, 70, 70, 102, 102, 156, 190, 153, 153, 153, 153, 153,
                              250,
                              170, 30,
    ...
    def get_res(self):
        ...
        result = {
            'update': f'Update:{(self.optim != pre)} pre:{pre} Optim:{self.optim}',
            'iou': iou,
            'miou': miou,
            'PA': PA,
            'CPA': cpa,
