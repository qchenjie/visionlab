...
from nets.MIssFormer.segformer import *
...
class MISSFormer(nn.Module):
    def __init__(self, num_classes = 9, token_mlp_mode = "mix_skip", encoder_pretrained = True,
        ...
        heads = [ 1, 2, 5, 8 ]
        d_base_feat_size = 7  # 16 for 512 inputsize   7for 224  8 for 256 custom
...
if __name__ == '__main__':
    ...
    net = MISSFormer(num_classes=num_classes,img_size = img_size).cuda()
