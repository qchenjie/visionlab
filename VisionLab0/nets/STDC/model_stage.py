...
from nets.STDC.stdcnet import STDCNet1446, STDCNet813
...
class BiSeNet(nn.Module):
    def __init__(self, backbone, n_classes, pretrain_model = '', use_boundary_2 = False, use_boundary_4 = False,
                 use_boundary_8 = False, use_boundary_16 = False, use_conv_last = False, heat_map = False, *args,
                 **kwargs):
...
if __name__ == "__main__":
    net = BiSeNet('STDCNet813', 2,use_boundary_8 = True)
    net.cuda()
    net.eval()
    in_ten = torch.randn(1, 3, 512, 512).cuda()
    out, out16, out32,b = net(in_ten)
    # print(out.shape)
    # torch.save(net.state_dict(), 'STDCNet813.pth')
    for o in [out,out16,out32,b]:
        print(o.shape)
