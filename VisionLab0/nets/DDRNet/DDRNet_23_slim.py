...
def DualResNet_imagenet(pretrained=False,num_classes = 2,augment = False):
...
def get_seg_model(*args, **kwargs):

    model = DualResNet_imagenet(pretrained=kwargs['pretrained'],
...
if __name__ == '__main__':
    ...
    model = get_seg_model(pretrained = False,num_classes = 2,
                          augment = True).cuda()
    ...
    FPS: 135 135.59
    """
    flops_parameters(model, input=(x,))
