...
"""
import math
from nets.DconnNet.attention import CAM_Module,\
                                    PAM_Module,\
                                    GlobalAvgPool2D,GlobalAvgPool2DBaseline
import torch
from torchvision import models
import torch.nn as nn
from nets.backbone import resnet34,resnet50
...
class DconnNet(nn.Module):
    def __init__(self, num_class = 1):
        ...
        for layer in resnet34(pretrained = False):
    ...
    def __init__(self,
        ...
        for in_feat_os in in_feat_output_strides:
            ...
            self.blocks.append(nn.Sequential(*[
                nn.Sequential(
                    nn.Conv2d(in_channels[ dec_level ] if idx == 0 else out_channels, out_channels, 3, 1, 1,
                              bias = False),
...
if __name__ == '__main__':
   ...
   #-----------------------------------------------#
   #    TODO?  loss_main = self.loss_func(output, y)
